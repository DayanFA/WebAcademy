...
public class AtendimentoService implements IService<Atendimento> {
    ...
    public List<String> getHorarios(Long idProfissional, LocalDate data) {
        ...
        // List<Atendimento> atendimentos = repo.getHorarios(
