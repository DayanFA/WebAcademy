...
INSERT INTO `atendimento` VALUES
    ...
    (DEFAULT,'2023-12-04','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-04','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-04','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-04','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-05','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-05','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-05','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-05','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-06','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-06','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-06','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-06','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-07','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-07','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-07','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-07','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-08','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-08','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-08','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-08','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-11','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-11','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-11','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-11','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-12','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-12','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-12','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-12','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-13','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-13','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-13','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-13','15:00:00','AGENDADO',1,5,5),
    (DEFAULT,'2023-12-14','14:00:00','AGENDADO',1,2,3),
    (DEFAULT,'2023-12-14','14:30:00','AGENDADO',2,3,4),
    (DEFAULT,'2023-12-14','15:00:00','AGENDADO',3,4,1),
    (DEFAULT,'2023-12-14','15:00:00','AGENDADO',1,5,5);
...
INSERT INTO `usuario` VALUES
    (DEFAULT,TRUE,'Administrador','admin','ROLE_ADMIN','$2a$10$zArhMpAXoIhDRvqmJSPI2uDJbGxoQft9g2LCa.7fBCOXDuqKVC6cS'),
    (DEFAULT,TRUE,'Daniel','daniel','ROLE_ADMIN','$2a$10$ZKaOzSH3atFflX/Xs7.w2OqVwGiZNl/FhpPHyLt3AyI7YNaFmnFS2'),
    (DEFAULT,TRUE,'Paulo','paulo','ROLE_ATENDENTE','$2a$10$5gqHW3bQnDx62QNLM6BzyespOh5A649KDB6mNw9UOJbo8eQCAqyG6');
