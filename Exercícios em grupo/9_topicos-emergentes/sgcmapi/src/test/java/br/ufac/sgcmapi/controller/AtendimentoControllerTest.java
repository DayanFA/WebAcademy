...
public class AtendimentoControllerTest {
    ...
    public void testAtendimentoGetAll() throws Exception {
        ...
        Mockito.when(servico.get(Mockito.any(Pageable.class))).thenReturn(atendimentos);
    ...
    public void testAtendimentoGetByTermoBusca() throws Exception {
        ...
        Mockito.when(servico.get(Mockito.anyString(), Mockito.any(Pageable.class))).thenReturn(atendimentos);
