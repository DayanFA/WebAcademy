...
public class UsuarioControllerIntegrationTest {
    ...
    public void testUsuarioGetAll() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/config/usuario/"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.content[0].nomeCompleto", Matchers.is("Administrador")))
            .andExpect(MockMvcResultMatchers.jsonPath("$.content[1].nomeCompleto", Matchers.is("Daniel")))
            .andExpect(MockMvcResultMatchers.jsonPath("$.content[2].nomeCompleto", Matchers.is("Paulo")));
    }
