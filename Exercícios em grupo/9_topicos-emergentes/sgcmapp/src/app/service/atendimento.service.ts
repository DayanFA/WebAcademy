...
export class AtendimentoService implements IService<Atendimento> {
  ...
  get(termoBusca?: string | undefined, pageRequest?: PageRequest, apiUrl?: string): Observable<PageResponse<Atendimento>> {
  ...
  getAgendamentos(termoBusca?: string | undefined, pageRequest?: PageRequest): Observable<PageResponse<Atendimento>> {
    let url = this.apiUrl + "lista-agendamentos/";
    return this.get(termoBusca, pageRequest, url);
  }

  getAtendimentos(termoBusca?: string | undefined, pageRequest?: PageRequest): Observable<PageResponse<Atendimento>> {
    let url = this.apiUrl + "lista-atendimentos/";
    return this.get(termoBusca, pageRequest, url);
  }
