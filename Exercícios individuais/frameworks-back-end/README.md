...
1. [INDIVIDUAL] Modifique a classe `Unidade` utilizando as anotações necessárias para aplicar a técnica de ORM, a exemplo do que foi feito com a classe `Especialidade`. (Entrega: 02/10/2023)
